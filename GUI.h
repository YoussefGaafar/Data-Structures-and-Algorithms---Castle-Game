...
public:
	...
	void UpdateStatusBar(int TimeStep, double health, CASTLE_STATUS stat, int actfi, int actfre, int acthea,int acttot, int frofi, int frofre,int froheal,int frotot, int killfi, int killfre, int killheal, int totkill);	//prints info on status bar. Info includes timestep and other enemies info as illustrated in project doc
	void UpdateInterface(int TimeStepint, double health, CASTLE_STATUS stat, int actfi, int actfre, int acthea, int acttot, int frofi, int frofre, int froheal, int frotot, int killfi, int killfre, int killheal, int totkill);
